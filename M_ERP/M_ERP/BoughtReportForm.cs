...
namespace M_ERP
{
    public partial class BoughtReportForm : Form
    {

        MySqlCommand cmd;
        MySqlDataReader reader;
        double totalBought, total_retun_Bought, total_diff;
        double discount, discount_return;
        int SellType = 2;
        int SellReturnType = 4;

        public BoughtReportForm()
        {
            InitializeComponent();
        ...
        private void populateGrid()
        {
            ...
            if(populateTF)
            {
                try
                {
                    ...
                    populateLog();
                    SaleBox.Text = Convert.ToString(totalBought);
                    returnSaleTB.Text = Convert.ToString(total_retun_Bought);
        ...
        private void populateLog()
        {
            ...
            while (reader.Read())
            {
                ...
                totalBought += (currentBuyPrice * logIN);
                total_retun_Bought += (currentBuyPrice * logOUT);

                total_diff = totalBought - total_retun_Bought - discount + discount_return;
                try
                {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            while (iRow <= dGridV_InvenLog.Rows.Count - 1)
            {
                ...
                else
                {
                    ...
                    {
                        //Draw Header
                        e.Graphics.DrawString("تقرير المشتريات", new Font(dGridV_InvenLog.Font, FontStyle.Bold),
                                Brushes.Black, e.MarginBounds.Left, e.MarginBounds.Top -
                                e.Graphics.MeasureString("تقرير المشتريات", new Font(dGridV_InvenLog.Font,
                        ...
                        e.Graphics.DrawString(strDate, new Font(dGridV_InvenLog.Font, FontStyle.Bold),
                                ...
                                e.Graphics.MeasureString("تقرير المشتريات", new Font(new Font(dGridV_InvenLog.Font,
        ...
        public void ExportToExcel()
        {
            ...
            if (fbd.SelectedPath != "")
            {
                ...
                string filepath = fbd.SelectedPath + "\\المشتريات.xlsx";
                int i = 1;


                filepath = fbd.SelectedPath + "\\المشتريات" + "_" + date + ".xls";

                list_export = xlApp.Workbooks.Add();
                Worksheet_export = list_export.Worksheets.Add();
                Worksheet_export.Name = "المشتريات";
